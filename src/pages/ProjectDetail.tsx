    ...
    return (
      <>
        <MetaTags
          ...
          description="The project you're looking for doesn't exist. Please return to the work page to find other projects."
        />
  ...
  return (
    <>
      <MetaTags
        ...
        imageUrl={project.heroImage ? getSanityImageUrl(project.heroImage) : undefined}
