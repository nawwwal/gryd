...
const Playground = () => {
  ...
  return (
    <>
      <MetaTags
        title="Playground - Experiments & Dead Ends"
        description="A collection of creative experiments, prototypes, and dead ends from the lab of Aditya Nawal. Explore the process of design and development."
        keywords="Playground, experiments, prototypes, creative coding, design, development"
      />
