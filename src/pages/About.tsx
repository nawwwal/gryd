...
const About = () => {
  ...
  return (
    <>
      <MetaTags
        title="About the Editor - Aditya Nawal"
        description="Learn more about Aditya Nawal, the product designer and developer behind The GRYD. Discover his experience, skills, and creative philosophy."
        keywords="About Aditya Nawal, product designer, developer, resume, experience, skills"
      />
